> Copied verbatim from [BasedHardware/omi](https://github.com/BasedHardware/omi/blob/main/ISSUE_TRIAGE_GUIDE.MD)
> (MIT licensed, © Based Hardware Contributors — see `NOTICE.md`). `user_signals/score.py`
> in this repo implements the Priority Score formula from section 5 automatically.
